...
const UpcomingContentTab = () => {
  ...
  const cleanupMutation = useManualCleanup();
  const { toast } = useToast();

  // Note: Automatic cleanup removed to prevent database conflicts
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="trailer-url" className="text-foreground">Embed Trailer URL</Label>
                <Input
                  id="trailer-url"
            ...
            {upcomingContents.length > 0 && (
              <>
                <Button 
                  ...
                  className="flex items-center gap-2 bg-background/50 border-border/50 hover:bg-background/70"
                >
